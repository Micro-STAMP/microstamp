            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.header}>
                    ...
                    <div className={styles.actions}>
                        ...
                        <button
                            onClick={() => navigate(`/analyses/${analysisId}/cast/report`)}
                            className={styles.btnSaveForm}
                        >
                            <BiFile size={18} /> Generate Report
                        </button>
                    </div>
                </div>
