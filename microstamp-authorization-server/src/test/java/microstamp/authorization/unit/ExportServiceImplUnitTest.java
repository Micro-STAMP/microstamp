...
public class ExportServiceImplUnitTest {
    ...
    void exportToJsonWhenItIsAGuestGenerateTheJson() {
        ...
        Step4ExportReadDto mockStep4ExportRead = assembleStep4Export.get();
        ...
        assertAll(
                ...
                () -> assertEquals(mockStep4ExportRead, response.getStep4())
        );
    }
    ...
    private final Supplier<Step4ExportReadDto> assembleStep4Export = () -> Step4ExportReadDto.builder()
            .fourTuples(List.of())
            .unsafeControlActions(List.of())
            .build();
}
