...
import step3.dto.mit.safety_constraint.SafetyContraintUpdateDto;
...
public class SafetyConstraintService {
    ...
    public SafetyConstraintReadDto updateSafetyConstraint(UUID id, SafetyContraintUpdateDto safetyConstraint) {
